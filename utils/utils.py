...
from utils.colorize_mask import cityscapes_colorize_mask, camvid_colorize_mask, river_colorize_mask
...
def save_predict(output, gt, img_name, dataset, save_path, output_grey=True, output_color=False, gt_color=False):
    if output_grey:
        ...
        output_grey.save(os.path.join(save_path, img_name))
    ...
    if output_color:
        if dataset == 'cityscapes':
            ...
            output_color = river_colorize_mask(output)    
